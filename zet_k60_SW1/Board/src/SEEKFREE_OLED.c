...
#define oled_p6x8str(x,y,ch)            OLED_P6x8Str(x,y,ch)
#define oled_set_pos(x,y)               OLED_Set_Pos(x, y)
#define oled_fill(bmp_data)             OLED_Fill(bmp_data)
#define oled_p6x8str(x,y,ch)            OLED_P6x8Str(x,y,ch)
#define oled_p8x16str(x,y,ch)           OLED_P8x16Str(x,y,ch)
#define oled_print_num(x,y,num)         OLED_Print_Num(x,y,num)
#define oled_print_num1(x,y,num)        OLED_Print_Num1(x,y,num)
